...
// VerifyTransferAgreement provides a mock function with given fields: ctx, in, opts
func (_m *MockContractServiceClient) VerifyTransferAgreement(ctx context.Context, in *dspv1alpha2.VerifyTransferAgreementRequest, opts ...grpc.CallOption) (*dspv1alpha2.VerifyTransferAgreementResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for VerifyTransferAgreement")
	}

	var r0 *dspv1alpha2.VerifyTransferAgreementResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *dspv1alpha2.VerifyTransferAgreementRequest, ...grpc.CallOption) (*dspv1alpha2.VerifyTransferAgreementResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *dspv1alpha2.VerifyTransferAgreementRequest, ...grpc.CallOption) *dspv1alpha2.VerifyTransferAgreementResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*dspv1alpha2.VerifyTransferAgreementResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *dspv1alpha2.VerifyTransferAgreementRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockContractServiceClient_VerifyTransferAgreement_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'VerifyTransferAgreement'
type MockContractServiceClient_VerifyTransferAgreement_Call struct {
	*mock.Call
}

// VerifyTransferAgreement is a helper method to define mock.On call
//   - ctx context.Context
//   - in *dspv1alpha2.VerifyTransferAgreementRequest
//   - opts ...grpc.CallOption
func (_e *MockContractServiceClient_Expecter) VerifyTransferAgreement(ctx interface{}, in interface{}, opts ...interface{}) *MockContractServiceClient_VerifyTransferAgreement_Call {
	return &MockContractServiceClient_VerifyTransferAgreement_Call{Call: _e.mock.On("VerifyTransferAgreement",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockContractServiceClient_VerifyTransferAgreement_Call) Run(run func(ctx context.Context, in *dspv1alpha2.VerifyTransferAgreementRequest, opts ...grpc.CallOption)) *MockContractServiceClient_VerifyTransferAgreement_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*dspv1alpha2.VerifyTransferAgreementRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockContractServiceClient_VerifyTransferAgreement_Call) Return(_a0 *dspv1alpha2.VerifyTransferAgreementResponse, _a1 error) *MockContractServiceClient_VerifyTransferAgreement_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockContractServiceClient_VerifyTransferAgreement_Call) RunAndReturn(run func(context.Context, *dspv1alpha2.VerifyTransferAgreementRequest, ...grpc.CallOption) (*dspv1alpha2.VerifyTransferAgreementResponse, error)) *MockContractServiceClient_VerifyTransferAgreement_Call {
	_c.Call.Return(run)
	return _c
}
